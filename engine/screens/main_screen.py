...
class Main_screen():
    def __init__(self, theme, window, manager):
        ...
        cont_features.add_leaf(Axis_explained("ax1", (0., 0.), (1., 0.485), parent=cont_features, uid_generator=manager.uid_generator, color=np.array([161., 94., 249.]), manager=manager))
        cont_features.add_leaf(Axis_explained("ax2", (0., 0.505), (1., 0.485), parent=cont_features, uid_generator=manager.uid_generator, color=np.array([249., 151., 94.]), manager=manager))
